export function getTopicPickerPrompt(previousTopics: string[]): string {
  const avoidSection =
  ...
  return `You are an SEO strategist for Dawn & Ron (dawnandron.com), a site that helps non-U.S. residents, remote entrepreneurs, and digital nomads start and scale U.S.-based businesses.
...
- Fits one of these content pillars: LLC formation, EIN acquisition, US bank accounts, payment processing, remote business operations, tax basics for non-residents${avoidSection}
